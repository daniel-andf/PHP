...
<figcaption>
            ...
            <div class="team-social-meta">
                  <ul>
                   <?php if($fontaws1link!='') { ?><li  class="team-social-social"><a href="<?php echo $fontaws1link?>"><i style="color:<?php echo $color; ?>" class="<?php echo $fontaws1; ?>"></i></a></li> <?php } ?> <!-- My personal customization --> 
                  <?php if($fontaws2link!='') { ?><li  class="team-social-social"><a href="<?php echo $fontaws2link?>"><i  style="color:<?php echo $color; ?>" class="<?php echo $fontaws2; ?>"></i></a></li> <?php } ?> <!-- My personal customization --> 
                  <?php if($fontaws3link!='') { ?><li class="team-social-social"><a href="<?php echo $fontaws3link?>"><i  style="color:<?php echo $color; ?>"  class="<?php echo $fontaws3; ?>"></i></a></li> <?php } ?> <!-- My personal customization --> 
                  <?php if($fontaws4link!='') { ?><li class="team-social-social"><a href="<?php echo $fontaws4link?>"><i style="color:<?php echo $color; ?>"  class="<?php echo $fontaws4; ?>"></i></a></li> <?php } ?> <!-- My personal customization --> 
                  </ul>
              </div>
            </figcaption>
            </figure>   
